...
def get_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--feature_extractor",
        default=r"S:\ano_dec_pro\AnomalyDetectionCVPR2018-Pytorch\pretrained\c3d.pickle",
    ...
    parser.add_argument(
        "--ad_model",
        default=r"S:\ano_dec_pro\AnomalyDetectionCVPR2018-Pytorch\exps\c3d\models\epoch_80000.pt",
    ...
    def run(self) -> None:
        while self._run_flag:
            with self._stack._lock:
                ...
                batch = list(reversed(self._stack.get()))
